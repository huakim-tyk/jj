...
#define _transient  0x0080     //# or varargs or static_phase
#define _synchronized  0x0020  //# or super or open or transitive
#define _native  0x0100
#define _strictfp  0x0800
#define _class  0x10000       //# not present
#define _default  0x100000     //# not present
...
//this function returns an closing bracket pair
...
(std::wostream& os,init m) -> std::wostream& { 
    ...
    //    return os<<L'"'<<L'"'<<L'"'<<m.b2<<L'"'<<L'"'<<L'":('<<m.line<<L","<<m.position<<L")";
...
this version of ejavac");
                ...
                // 
                #ifdef check_buf
                wcout<<"got from burger heroes"<<endl;
                wcout<<a<<endl;
...
"/DATA/B/doc/WS/compiler/untitled/ejavac/src/main/java/com/ejavac/task.java");
...
jobject get(init &i)
{
    ...
    //    wcout<<"line: "<<line<<" position: "<<position<<" name: "<<i.b2<<endl;
        
        jobject ret = glb::env->NewObject(glb::tok, glb::initT, glb::source, j, line, position);
    ...
    //    wcout<<"ERROR3"<<endl;
        ...
        auto vec = i.b3;
        int l = vec.size();
        jobject ret = glb::env->NewObject(glb::obj, 
        glb::initO, l);
...
load_class (obj,"java/util/ArrayList")
load_class (str,"java/lang/String")
load_class (tok,"Token")
...
glb::initD = initD;
load_method(initO, obj, "<init>", "(I)V");
...
JNIEXPORT jobject JNICALL Java_Compiler_fileToAST
  (JNIEnv * env, jclass cls, jstring name){

glb::on_load(env);

 //wcout<<L"fuck you"<<endl;
